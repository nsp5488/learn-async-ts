...
function handleAliceTransformations() {
    return __awaiter(this, void 0, void 0, function () {
        var aliceTumbling1, aliceTiming1, alice10, alice20, alice30, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    err_1 = _a.sent();
                    alert("Error when promising ... ".concat(err_1));
                    return [3 /*break*/, 6];
